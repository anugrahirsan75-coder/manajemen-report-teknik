...
const JALUR: Record<string, ReactNode> = {
  ...
  keranjang: <><path d="M3 4.5h2.2l2.1 10.2a1.6 1.6 0 0 0 1.6 1.3h7.6a1.6 1.6 0 0 0 1.6-1.2l1.6-6.3H6" /><circle cx="9.5" cy="19.5" r="1.4" /><circle cx="17" cy="19.5" r="1.4" /></>,
  ...
  klip: <><path d="M18 8.5 10.2 16.3a2.6 2.6 0 0 1-3.7-3.7l8.3-8.3a4 4 0 0 1 5.7 5.7l-8.4 8.4a5.5 5.5 0 0 1-7.8-7.8l7.6-7.6" /></>,
  segarkan: <><path d="M20 12a8 8 0 1 1-2.6-5.9" /><path d="M20.5 4v4.5H16" /></>,
  salin: <><rect x="9" y="9" width="11" height="11" rx="2" /><path d="M15 6.5A2.5 2.5 0 0 0 12.5 4H6a2 2 0 0 0-2 2v6.5A2.5 2.5 0 0 0 6.5 15" /></>,
  lembar: <><rect x="4" y="3.5" width="16" height="17" rx="2" /><path d="M4 9h16M9.5 9v11.5M4 15h16" /></>,
  keluarTaut: <><path d="M14 4h6v6" /><path d="m20 4-8.5 8.5" /><path d="M18 14v4.5A1.5 1.5 0 0 1 16.5 20h-11A1.5 1.5 0 0 1 4 18.5v-11A1.5 1.5 0 0 1 5.5 6H10" /></>,
